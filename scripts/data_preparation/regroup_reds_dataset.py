...
if __name__ == '__main__':
    # train_sharp
    train_path = '/home/user/REDS/train/train_sharp'
    val_path = '/home/user/REDS/train/train_sharp_bicubic/train_sharp_bicubic/X4'
    regroup_reds_dataset(train_path, val_path)

    # train_sharp_bicubic
    train_path = 'datasets/REDS/train_sharp_bicubic/X4'
    val_path = '/home/user/REDS/val/val_sharp_bicubic/val_sharp_bicubic/X4'
    regroup_reds_dataset(train_path, val_path)
