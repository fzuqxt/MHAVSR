...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/mnt/ai2022/qxt/datasetsr/vid4-dataset-main/city', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/mnt/ai2022/qxt/VSR/BasicSR-master/results/MHAVSR_Vid4_BD/visualization/Vid4/city', help='Path to restored images')
