...
if __name__ == '__main__':
    spynet_path = '/mnt/ai2022/qxt/VSR/BasicSR-master/spynet_sintel_final-3d2a1287.pth'
    model = EDVR1(with_tsa=True).cuda()
    input = torch.rand(1, 5, 3, 180, 320).cuda()
    ...
    with torch.no_grad():
     ...
     # torch.cuda.synchronize()Data
            ...
            # print("runtimes", (end - start))
            print('===================')
            print(output.shape)
    print("avg time:", np.mean(time_avgs))